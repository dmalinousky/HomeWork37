...
public class HW37MainClass {
    public static void main(String[] args) throws InterruptedException {
        ...
        Stop route_1_Stop_1 = new Stop(2, "point #1");
        Stop route_1_Stop_2 = new Stop(3, "point #2");
        Stop route_1_Stop_3 = new Stop(1, "point #3");
        Stop route_1_Stop_4 = new Stop(4, "point #4");
        Stop route_1_Stop_5 = new Stop(3, "point #5");
        Stop route_1_Stop_6 = new Stop(1, "point #6");
        ...
        // Bus creating
        Bus bus1 = new Bus("Bus-1", 2000, route1);
        Bus bus2 = new Bus("Bus-2", 3000, route1);
        Bus bus3 = new Bus("Bus-3", 5000, route1);
        Bus bus4 = new Bus("Bus-4", 3500, route1);
        Bus bus5 = new Bus("Bus-5", 2500, route1);
